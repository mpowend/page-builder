...
import { RootState, load } from '@/features/pagebuilder/store'
...
const Start = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col font-vazir">
      ...
      >
        <button className="w-full rotate-180 rounded-md bg-yellow-100">
          ▼
        </button>
      </div>
      <nav className="z-10 flex flex-row items-center p-3 shadow-md">
        ...
        <div className="mx-auto w-0 grow text-center text-blue-600">
          نام صفحه
        </div>
